...
departments.dept_name;</h4>
		...
		<p class="avgSalaryRightColumn"><span style="font-weight:700">NOTE:</span> This query takes 9.59 seconds to run on my Linode.. so here's a 
picture of the result instead.</p>
		
	</div>
	
<!-- Writing MySQL Functions Section -->
